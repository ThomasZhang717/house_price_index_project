...
```{r}
full_data_merge$LAND_ARE[which(full_data_merge$LAND_ARE == 0)] = NA
full_data_merge$AREA_HSE[which(full_data_merge$AREA_HSE == 0)] = NA
full_data_merge$YEAR_BUI[which(full_data_merge$YEAR_BUI < 1860)] = NA
...
#correct land area 5010000 to 501 in victoria park
full_data_merge$LAND_ARE[which(full_data_merge$LAND_ARE == 5010000)] = 501
```
