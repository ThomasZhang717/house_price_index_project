...
indices_plot = ggplot(indice, aes(quarter, index, color = method, linetype = method)) + geom_line(size = 1.2) + scale_color_grey(start = 0, end = 0.8, limits = c("ABS Index", "DIT", "DIT_Chained", "MLF", "MLR", "RS"), labels = c("ABS Index", "HI Index", "HI_Chained Index", "MLF Index", "MLR Index", "Repeat Sales Index")) + scale_linetype_discrete(limits = c("ABS Index", "DIT", "DIT_Chained", "MLF", "MLR", "RS"), labels = c("ABS Index", "HI Index", "HI_Chained Index", "MLF Index", "MLR Index", "Repeat Sales Index")) + theme_bw() + scale_x_continuous(name = "Quater",breaks = c(1, 17, 33, 49, 65), labels = c("2004Q1", "2008Q1", "2012Q1", "2016Q1", "2020Q1"))
