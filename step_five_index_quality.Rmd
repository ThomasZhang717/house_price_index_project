...
mlf_index = read.csv("./data/mlf_index_alt_quarterly.csv")
mlr_index = read.csv("./data/mlr_index_alt_quarterly.csv")
dit_index = read.csv("./data/dit_index_impute_1t_quarterly.csv")
dit_index_chained = read.csv("./data/dit_index_impute_chained_quarterly.csv")
